...
data.rda <- read.table("Ruttan\\ruttan.rda.data.csv", header=T,sep=",")
...
indicator.data <- read.table("Ruttan\\ruttan.evenness.csv",header=T,sep=",")
...
```{r, bee analyses}
#bee normality ####
data_ruttan <- read.table("Ruttan\\ruttan.bee.csv",header=T,sep=",")

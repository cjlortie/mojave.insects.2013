...
```{r, community analyses, include=FALSE}
#RDA ####

#ANOVA ####
#A two-way crossed-factor ANOVA with permu- tation tests was used to test for differences in arthropod commu- nity structure between shrub and open microsites

#ISA ####
#An Indicator Species Analysis (ISA) was also used to explore whether certain species were more strongly indicative of either of the two microsite classifications tested and was per- formed with the ‘indval’ function (package: ‘indicspecies’) in R.
...
```{r, environmental drives, include=FALSE}
